...
#include "HiiDatabaseDxe/HiiDatabase.h"
...
///
EFI_HII_FONT_PROTOCOL  *gHiiFont = &mPrivate.HiiFont;

///
/// Pointer to the UEFI HII String Protocol
///
EFI_HII_STRING_PROTOCOL  *gHiiString = &mPrivate.HiiString;

///
/// Pointer to the UEFI HII Image Protocol
///
EFI_HII_IMAGE_PROTOCOL  *gHiiImage = &mPrivate.HiiImage;

///
/// Pointer to the UEFI HII Database Protocol
///
EFI_HII_DATABASE_PROTOCOL  *gHiiDatabase = &mPrivate.HiiDatabase;

///
/// Pointer to the UEFI HII Config Rounting Protocol
///
EFI_HII_CONFIG_ROUTING_PROTOCOL  *gHiiConfigRouting = &mPrivate.ConfigRouting;
...
EFI_STATUS
EFIAPI
HiiServicesLibDriverConstructor (
  IN EFI_HANDLE        ImageHandle,
  IN EFI_SYSTEM_TABLE  *SystemTable
  )
{
