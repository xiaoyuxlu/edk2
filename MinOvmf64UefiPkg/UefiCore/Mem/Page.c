  ...
  )
{
  ...
  DEBUG ((
    DEBUG_INFO,
    "CoreAddMemoryDescriptor - (0x%x) 0x%lx - 0x%lx\n",
    Type,
    Start,
    Start + LShiftU64 (NumberOfPages, EFI_PAGE_SHIFT)
    ));
  ...
  )
{
  ...
  while ((UINTN)MemoryMapEntry < (UINTN)MemoryMapEnd) {
    ...
    do {
      MemoryBlockLength = (UINT64) (LShiftU64 (NewMemoryMapEntry->NumberOfPages, EFI_PAGE_SHIFT));
