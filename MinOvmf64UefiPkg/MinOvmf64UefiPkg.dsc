...
################################################################################
[Defines]
  PLATFORM_NAME                  = MinOvmf64Uefi
  PLATFORM_GUID                  = 23935348-A8FB-4FD0-AB60-1B6CD1222488
  PLATFORM_VERSION               = 0.1
  DSC_SPECIFICATION              = 0x00010005
  OUTPUT_DIRECTORY               = Build/MinOvmf64Uefi
  SUPPORTED_ARCHITECTURES        = X64
  BUILD_TARGETS                  = NOOPT|DEBUG|RELEASE
  SKUID_IDENTIFIER               = DEFAULT
  FLASH_DEFINITION               = MinOvmf64UefiPkg/MinOvmf64UefiPkg.fdf
...
[Components]
  ...
  # DXE Phase modules
  #
  MinOvmf64UefiPkg/UefiCore/UefiMain.inf {
    <LibraryClasses>
