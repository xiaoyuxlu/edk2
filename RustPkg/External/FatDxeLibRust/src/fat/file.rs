...
use crate::fat::Error as FatError;
...
pub extern "win64" fn open(
    ...
    if path == ".." {
        ...
        let protocol_address = (*wrapper).parent;
        unsafe{
                ...
                match f.file_type {
                    FileType::Directory => {
                        unsafe{
                            ...
                            (*file_out_wrapper).parent = &(*wrapper).proto as *const FileProtocol as u64;
                        }
                    }
                    FileType::File => {
                        unsafe {
...
pub extern "win64" fn close(proto: *mut FileProtocol) -> Status {
    let _wrapper = container_of!(proto, FileWrapper, proto);
    Status::SUCCESS
}
...
pub extern "win64" fn read(file: *mut FileProtocol, size: *mut usize, buf: *mut c_void) -> Status {
    ...
    match wrapper_value.dir_entry.file_type {
        ...
        crate::fat::FileType::Directory => {
            ...
            unsafe {
                let _fs = (*wrapper).fs;
                let _cluster = (*wrapper).dir_entry.cluster;
                ...
                match directory.next_entry() {
                    ...
                    Ok(de) => {
                        ...
                        let fname = core::str::from_utf8_unchecked(&long_name);
...
impl<'a> FileSystemWrapper<'a> {
    ...
    fn create_file(&self, _root: bool) -> Option<*mut FileWrapper> {
...
pub extern "win64" fn open_ex(_file: *mut FileProtocol, _out_file: *mut *mut FileProtocol, _path: *mut efi::Char16, _: u64, _: u64, _io_token: *mut efi::protocols::file::IoToken) -> Status {
    Status::UNSUPPORTED
}
pub extern "win64" fn read_ex(_file: *mut FileProtocol, _io_token: *mut efi::protocols::file::IoToken) -> Status {
    Status::UNSUPPORTED
}
pub extern "win64" fn write_ex(_file: *mut FileProtocol, _io_token: *mut efi::protocols::file::IoToken) -> Status {
    Status::UNSUPPORTED
}
pub extern "win64" fn flush_ex(_file: *mut FileProtocol, _io_token: *mut efi::protocols::file::IoToken) -> Status {
    Status::UNSUPPORTED
}