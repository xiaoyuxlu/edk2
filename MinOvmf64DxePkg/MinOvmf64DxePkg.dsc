...
################################################################################
[Defines]
  PLATFORM_NAME                  = MinOvmf64Dxe
  PLATFORM_GUID                  = E56A2847-8F8D-4DB4-9E21-20BEE2751657
  PLATFORM_VERSION               = 0.1
  DSC_SPECIFICATION              = 0x00010005
  OUTPUT_DIRECTORY               = Build/MinOvmf64Dxe
  SUPPORTED_ARCHITECTURES        = X64
  BUILD_TARGETS                  = NOOPT|DEBUG|RELEASE
  SKUID_IDENTIFIER               = DEFAULT
  FLASH_DEFINITION               = MinOvmf64DxePkg/MinOvmf64DxePkg.fdf
...
################################################################################
[Components]
  MinOvmf64DxePkg/ResetVector/ResetVector.inf

  #
  # SEC Phase modules
  #
  MinOvmf64DxePkg/Sec/SecMain.inf
  ...
  MinOvmf64DxePkg/Override/UefiCpuPkg/LocalApicTimerDxe/LocalApicTimerDxe.inf
  ...
  MinOvmfPkg/AcpiTables/AcpiTables.inf
